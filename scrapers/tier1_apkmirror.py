    ...
    def _safe_get(self, ctx: Context, url: str) -> Optional[Any]:
        ...
        for attempt in range(4):
            try:
                ...
                # The explicit check for 'apkmirror in title' was removed as variant pages
                # dynamically generated by APKMirror frequently omit the site name,
                # which was triggering self-sabotaging rotation loops on valid HTTP 200s.
                is_blocked = (
